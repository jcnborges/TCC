...
//TESTE
float valortestes[11] = {18,20,25,40,40,150,75,20,150,220,230};
float valortestes2[11] = {40,20,25,30,40,50,20,100,125,50,30};
float valortestes3[11] = {45,21,25,30,100,50,75,20,75,220,230};

for(int i = 0;i<11;i++){
	PercPwm = fc.make_inference(valortestes[i],valortestes2[i],valortestes3[i]);
	Ang = fc2.make_inference(valortestes[i],valortestes2[i],valortestes3[i]);
	printf("(%f,%f,%f) : (%f,%f)\n",valortestes[i],valortestes2[i],valortestes3[i],PercPwm,Ang);
}
//FIM TESTE
return 0;
}
