...
*/
	...
	/*TESTE
	float valortestes[11] = {18,20,25,40,40,150,75,20,150,30,100};
	float valortestes2[11] = {40,20,25,30,40,50,20,100,125,50,130};
	float valortestes3[11] = {45,21,25,30,100,50,75,20,75,20,130};
