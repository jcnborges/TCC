...
Os algoritmos escolhidos foram um algoritmo baseado em logica fuzzy, que
...
Os objetivos do presente trabalho são a reconstrução e adequação do robô Bellator, a descrição do hardware e software do mesmo antes e após essa tarefa, a implementação dos algoritmos de navegação e a execução do experimento nos quais estes serão comparados. 
