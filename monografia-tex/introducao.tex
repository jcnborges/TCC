...
exemplo, um chassi com duas rodas trassionadas e uma terceira roda guia, um sistema de potência
...
sinais dos sensores e enconders, controlar a potência dos motores e comunicar-se através de um meio
...
diretamente em regras fuzzy, enquanto que o outro é um algoritmo baseado em FCM (Fuzzy Cognitive
...
A lógica fuzzy é uma aboardagem estudada no sétimo período na disciplina de sistemas inteligentes
...
robótica móvel e controladores industriais. O presente trabalho também colocará esses conceitos em 
