...
\section{Objetivos}
\label{rec:obj}
Os objetivos do presente trabalho são a reconstrução e adequação da plataforma robótica Bellator, a descrição do hardware e software do mesmo, antes e após esses procedimentos, o projeto e a implementação dos algoritmos de navegação, a execução de testes de comparação do comportamento dos algoritmos e a análise dos resultados provenientes desses testes.
