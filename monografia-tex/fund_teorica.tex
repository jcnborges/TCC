...
A equação \ref{fcm-update} descreve a evolução do FCM, na qual j é o contador das iterações, n é o número de nós do grafo, Wij é o peso do arco que conecta o conceito Cj ao conceito Ci, Ai e Ai_anterior são o valor do conceito Ci na iteração atual e anterior, respectivamente, e a função f \ref{sigmoide} é uma função do tipo sigmóide.
