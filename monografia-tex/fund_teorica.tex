...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=\textwidth]{./figs/fuzzygraph.png}
...
\end{center}
Sendo ``medio" e ``forte" valores possíveis da variável linguística Velocidade (V), que controla a velocidade do \emph{cooler}, com ``medio" correspondendo a função de pertinência vm e ``quente" correspondendo a vq, apresentados na figura a seguir:

%figura pertinencia velocidade
...
%TEXTO ANTERIOR. Remover? Tutorial fuzzy?
