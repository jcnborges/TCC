...
\end{center}
Sendo ``medio" e ``forte" valores possíveis da variável linguística Velocidade (V), que controla a velocidade do \emph{cooler}, com ``medio" correspondendo a função de pertinência vm e ``forte" correspondendo a vf, apresentados na figura \ref{defuzzygraph}:

\begin{figure}[!htb]
	\centering
	\includegraphics[width=\textwidth]{./figs/defuzzygraph.png}
