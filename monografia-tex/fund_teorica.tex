...
Uma aplicação direta de conjuntos fuzzy é a definição de variáveis linguísticas. \cite{PEDRYCZ} %pedrycz e gomide fuzzy systems toward human centric computing pg40
...
%descrever inferencias e concluir
