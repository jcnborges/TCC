...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.7\textwidth]{./figs/diagsis.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.7\textwidth]{./figs/fuzzygraph.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.7\textwidth]{./figs/defuzzygraph.png}
