...
\section{Placa de Roteamento} %Ainda vou(yuri) melhorar esta seção
...
O projeto da placa, métodos de desenvolvimento, requisitos entre outros, descritos de forma detalhada, estão disponíveis na seção \ref{sec:desroteamento}. 