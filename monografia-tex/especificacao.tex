...
Esta seção visa descrever todas as especificações do hardware do robô Bellator, utilizado na realização desse trabalho.
...
Uma imagem do robô, parcialmente montado, pode ser visualizada na figura \ref{fig:}
...
O diagrama esquemático da placa descrita pode ser observado na figura \ref{fig:roteamentosch}.
