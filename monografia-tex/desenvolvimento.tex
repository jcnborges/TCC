...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.7\textwidth]{./figs/roteamento_brd.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.7\textwidth]{./figs/placa-confeccao.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{./figs/lingvar.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{./figs/defuzzygraph_velmotor.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{./figs/defuzzygraph_ang.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{./figs/infrule.png}
