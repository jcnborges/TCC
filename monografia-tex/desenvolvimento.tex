...
\begin{table}[htb!]
	...
	\begin{tabular}[!htb]{ l l l l }
	  ...
	  \hline
		...
		$w_2$ & SD influencia GEF & Positivo & Forte \\
		$w_3$ & SD influencia GET & Positivo & Forte \\
		
		$w_4$ & SE influencia GEF & Positivo & Forte \\
		$w_5$ & SE influencia GDF & Positivo & Forte \\
		...
		$w_{12}$ & GDT influencia RD Out & Positi & Forte \\
...
\begin{equation}
\label{eq:gdf}
GDF=\frac {w_1f_2(SD)+w_5f_1(SE)-w_7f_2(SF)} {w_1+w_5+w_7}
\end{equation}

\begin{equation}
\label{eq:gdt}
GDT=\frac {w_6f_2(SE)+w_8f_2(SF)-w_{15}f_2(SD)} {w_6+w_8}
\end{equation}

\begin{equation}
\label{eq:gef}
GEF=\frac {w_4f_2(SE)+w_2f_1(SD)-w_9f_2(SF)} {w_4+w_2+w_9}
\end{equation}

\begin{equation}
\label{eq:get}
GET=\frac {w_3f_2(SD)+w_{10}f_2(SF)-w_{16}f_1(SE)} {w_3+w_{10}}
\end{equation}
