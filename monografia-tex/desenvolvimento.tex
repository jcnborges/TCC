...
Os testes dos algoritmos foram elaborados com três principais etapas:
\begin{enumerate}
    Testes Iniciais: Teste básico dos algoritmos visando observar a movimentação básica, sincronia das rodas e ajuste de parâmetros.
    Testes Avançados: Testes realizados com mais obstáculos para avaliar a capacidade dos algoritmos em evitar colisões com obstáculos.
    Testes Comparativos: Testes finais visando a comparação do comportamento entre os algoritmos em diversas situações
\end{enumerate}

Tanto os testes iniciais quanto os avançados são essenciais para proporcionar uma análise de resultados confiável entre os algoritmos. A comparação entre os algoritmos não deve ser afetada por mal escolha de parâmetros, regras ou conceitos
