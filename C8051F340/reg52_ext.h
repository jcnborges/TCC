...
//Fim do header original. Modificações e extensões abaixo.
...
/* PORT 0 - Adicionada por Douglas Melchioretto */ 
sbit P0_0  = P0^0;
sbit P0_1  = P0^1;
sbit P0_2  = P0^2;
sbit P0_3  = P0^3;
...
/* PORT 1 - Adicionada por Douglas Melchioretto */
sbit P1_0  = P1^0;
sbit P1_1  = P1^1;
sbit P1_2  = P1^2;
sbit P1_3  = P1^3;
...
/* PORT 2 - Adicionada por Douglas Melchioretto */
sbit P2_0  = P2^0;
sbit P2_1  = P2^1;
sbit P2_2  = P2^2;
sbit P2_3  = P2^3;
