...
#define PWM_RIGHT_FORWARD P1_2	// DEFINE O PINO NO QUE GERA A PWM PARA A RODA DIREITA GIRAR PARA FRENTE
#define PWM_RIGHT_REVERSE P1_0	// DEFINE O PINO NO QUE GERA A PWM PARA A RODA DIREITA GIRAR PARA TRAS
#define PWM_LEFT_FORWARD  P1_6	// DEFINE O PINO NO QUE GERA A PWM PARA A RODA ESQUERA GIRAR PARA FRENTE
#define PWM_LEFT_REVERSE  P1_4	// DEFINE O PINO NO QUE GERA A PWM PARA A RODA ESQUERA GIRAR PARA TRAS
